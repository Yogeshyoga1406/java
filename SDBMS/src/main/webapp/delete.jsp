...
<body  style=" background-image: url(https://static.scientificamerican.com/sciam/cache/file/4AC9C323-EF15-4344-BF4D79E5A5F152EA_source.jpg?w=1220&h=490);">
    <div>
        <h1 style="color: rgb(240, 214, 111);">Enter the ID of the Student that to be deleted</h1>
<br>
<form action="delete">
...
<br>
<br>
<h2 style="color: rgb(245, 79, 79); margin-left: 50px; font-size: 39px;">${deletemsg}</h2>
<br><br><br>
